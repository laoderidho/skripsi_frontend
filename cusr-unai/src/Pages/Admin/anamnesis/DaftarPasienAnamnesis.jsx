...
export default function DaftarPasienAnamnesis() {
                                ...
                                <Column 
                                    ...
                                    body={(rowData) => (
                                        <>
                                            ...
                                            <Link id="form-label" className='btn dashboard-button d-flex justify-content-center align-items-center' to={`/admin/pasien/anamnesis/${rowData.id}`}>
