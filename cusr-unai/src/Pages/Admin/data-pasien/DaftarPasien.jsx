  ...
  return (
    <Sidebar>
      ...
      <div className="container pt-5">
        ...
        <DataTable value={loading ? dummyData : (inputValue ? filterPasien : pasien)} paginator rows={10}  tableStyle={{ minWidth: '50rem' }}  stripedRows show showGridlines className="mt-3">
          <Column 
            field="" 
