                ...
                <React.Fragment>
                    ...
                    {isProfilePath ? (
                            <React.Fragment>
                                ...
                                <div className='header-navbar-mobile d-flex justify-content-center align-items-center '>
                                    <div className='mt-2'>
                                        <h6>{title}</h6>
                                    </div>
                                </div>
                            ...
                            <React.Fragment>
                                <div style={{marginRight: '6rem'}} className='d-flex justify-content-between align-items-center'>
                                    <span>
                                        <button
                                            className="btn back"
                                            onClick={goBack}
                                ...
                                <span>
                                    <div className=''>
                                        <h6 style={{marginTop: '0.5rem', textAlign:'center'}}>{title}</h6>
                                    </div>
                                </span>
                    ...
                    {/* Content */}
                    <div className='content form-margin content-mobile'>{children}</div>
                    ...
                    <nav className='navbar-bottom mobile-navbar'>
                        ...
                        <div className={`navbar-child ${currentPath === "/perawat/profile" ? "link-active" : ""}`}>
                            <Link  className={`navbar-link ${currentPath === "/perawat/profile" ? "link-active-text" : ""}`} to={`/perawat/profile`}>
                                <Row>
                                    <Col>
                                        <svg xmlns="http://www.w3.org/2000/svg" width='25' height='25' viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
